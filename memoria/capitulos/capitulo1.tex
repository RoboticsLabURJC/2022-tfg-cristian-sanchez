...
Existen múltiples avances y ejemplos posteriores, pero en la actualidad podemos definir un \ac{UAS} (ver figura~\ref{fig:drone_components}) teniendo en cuenta lo siguiente:
