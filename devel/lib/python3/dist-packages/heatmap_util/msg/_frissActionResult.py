...
"""autogenerated by genpy from heatmap_util/frissActionResult.msg. Do not edit."""
import codecs
import sys
...
class frissActionResult(genpy.Message):
  _md5sum = "5bae66f9554f76c9c0fc452d43792232"
  _type = "heatmap_util/frissActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','heatmap_util/frissResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(frissActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = heatmap_util.msg.frissResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = heatmap_util.msg.frissResult()
