...
"""autogenerated by genpy from heatmap_util/RvizFrissActionResult.msg. Do not edit."""
import codecs
import sys
...
class RvizFrissActionResult(genpy.Message):
  _md5sum = "3e855c5706fce452806614539f2d5a63"
  _type = "heatmap_util/RvizFrissActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','heatmap_util/RvizFrissResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RvizFrissActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = heatmap_util.msg.RvizFrissResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = heatmap_util.msg.RvizFrissResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.result.data))
      _x = self.result.size
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.result.data = s.unpack(str[start:end])
      start = end
      end += 2
      (self.result.size,) = _get_struct_h().unpack(str[start:end])
      return self
