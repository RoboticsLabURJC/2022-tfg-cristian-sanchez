...
"""autogenerated by genpy from heatmap_util/GetPowerFrissActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class GetPowerFrissActionFeedback(genpy.Message):
  _md5sum = "24ce99ddda61eee22dd7cc896a7b21c7"
  _type = "heatmap_util/GetPowerFrissActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','heatmap_util/GetPowerFrissFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetPowerFrissActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = heatmap_util.msg.GetPowerFrissFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = heatmap_util.msg.GetPowerFrissFeedback()
