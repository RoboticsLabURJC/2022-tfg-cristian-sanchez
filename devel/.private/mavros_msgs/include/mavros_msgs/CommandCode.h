...
// reducing the odds to have name collisions with Windows.h 
...
#endif
#if defined(_WIN32) && defined(CAMERA_TRACK_POINT)
  #undef CAMERA_TRACK_POINT
#endif
#if defined(_WIN32) && defined(CAMERA_TRACK_RECTANGLE)
  #undef CAMERA_TRACK_RECTANGLE
#endif
#if defined(_WIN32) && defined(CAMERA_STOP_TRACKING)
  #undef CAMERA_STOP_TRACKING
#endif
...
#endif
#if defined(_WIN32) && defined(DO_ORBIT)
  #undef DO_ORBIT
#endif
...
#endif
#if defined(_WIN32) && defined(DO_SET_ACTUATOR)
  #undef DO_SET_ACTUATOR
#endif
  ...
  #undef DO_LAST
#endif
#if defined(_WIN32) && defined(DO_UPGRADE)
  #undef DO_UPGRADE
#endif
#if defined(_WIN32) && defined(DO_JUMP_TAG)
  #undef DO_JUMP_TAG
#endif
#if defined(_WIN32) && defined(DO_GIMBAL_MANAGER_PITCHYAW)
  #undef DO_GIMBAL_MANAGER_PITCHYAW
#endif
#if defined(_WIN32) && defined(DO_GIMBAL_MANAGER_CONFIGURE)
  #undef DO_GIMBAL_MANAGER_CONFIGURE
#endif
...
#endif
#if defined(_WIN32) && defined(ILLUMINATOR_ON_OFF)
  #undef ILLUMINATOR_ON_OFF
#endif
...
#endif
#if defined(_WIN32) && defined(INJECT_FAILURE)
  #undef INJECT_FAILURE
#endif
...
#endif
#if defined(_WIN32) && defined(PARAM_TRANSACTION)
  #undef PARAM_TRANSACTION
#endif
...
#endif
#if defined(_WIN32) && defined(SET_CAMERA_ZOOM)
  #undef SET_CAMERA_ZOOM
#endif
#if defined(_WIN32) && defined(SET_CAMERA_FOCUS)
  #undef SET_CAMERA_FOCUS
#endif
...
struct MD5Sum< ::mavros_msgs::CommandCode_<ContainerAllocator> >
{
  ...
  {
    return "d8ce11056552206c2686e10b02b9d99a";
  }

  static const char* value(const ::mavros_msgs::CommandCode_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xd8ce11056552206cULL;
  static const uint64_t static_value2 = 0x2686e10b02b9d99aULL;
};
...
"uint16 CONDITION_GATE = 4501                       # Delay mission state machine until gate has been reached.\n"
"\n"
"# MAV_CMD_CONTROL\n"
...
"uint16 DO_ORBIT = 34                               # Start orbiting on the circumference of a circle defined by the parameters. Setting any value NaN results in using defaults.\n"
...
"uint16 DO_SET_ACTUATOR = 187                       # Sets actuators (e.g. servos) to a desired value. The actuator numbers are mapped to specific outputs (e.g. on any MAIN or AUX PWM or UAVCAN) using a flight-stack specific mechanism (i.e. a parameter).\n"
...
"uint16 DO_SET_ROI_LOCATION = 195                   # Sets the region of interest (ROI) to a location. This can then be used by the vehicle's control system to control the vehicle attitude and the attitude of various sensors such as cameras. This command can be sent to a gimbal manager but not to a gimbal device. A gimbal is not to react to this message.\n"
"uint16 DO_SET_ROI_WPNEXT_OFFSET = 196              # Sets the region of interest (ROI) to be toward next waypoint, with optional pitch/roll/yaw offset. This can then be used by the vehicle's control system to control the vehicle attitude and the attitude of various sensors such as cameras. This command can be sent to a gimbal manager but not to a gimbal device. A gimbal device is not to react to this message.\n"
"uint16 DO_SET_ROI_NONE = 197                       # Cancels any previous ROI command returning the vehicle/sensors to default flight characteristics. This can then be used by the vehicle's control system to control the vehicle attitude and the attitude of various sensors such as cameras. This command can be sent to a gimbal manager but not to a gimbal device. A gimbal device is not to react to this message. After this command the gimbal manager should go back to manual input if available, and otherwise assume a neutral position.\n"
"uint16 DO_SET_ROI_SYSID = 198                      # Mount tracks system with specified system ID. Determination of target vehicle position may be done with GLOBAL_POSITION_INT or any other means. This command can be sent to a gimbal manager but not to a gimbal device. A gimbal device is not to react to this message.\n"
...
"\n"
"# MAV_CMD_ILLUMINATOR\n"
"uint16 ILLUMINATOR_ON_OFF = 405                    # Turns illuminators ON/OFF. An illuminator is a light source that is used for lighting up dark areas external to the sytstem: e.g. a torch or searchlight (as opposed to a light source for illuminating the system itself, e.g. an indicator light).\n"
"\n"
"# MAV_CMD_IMAGE\n"
...
"\n"
"# MAV_CMD_INJECT\n"
"uint16 INJECT_FAILURE = 420                        # Inject artificial failure for testing purposes. Note that autopilots should implement an additional protection before accepting this command such as a specific param setting.\n"
"\n"
"# MAV_CMD_JUMP\n"
...
"uint16 REQUEST_CAMERA_IMAGE_CAPTURE = 2002         # Re-request a CAMERA_IMAGE_CAPTURED message.\n"
