...
class GPSINPUT(genpy.Message):
  _md5sum = "cb7ec2e4d329f5e3b49203e079e2f644"
...
"""
  ...
  __slots__ = ['header','fix_type','gps_id','ignore_flags','time_week_ms','time_week','lat','lon','alt','hdop','vdop','vn','ve','vd','speed_accuracy','horiz_accuracy','vert_accuracy','satellites_visible']
  _slot_types = ['std_msgs/Header','uint8','uint8','uint16','uint32','uint16','int32','int32','float32','float32','float32','float32','float32','float32','float32','float32','float32','uint8']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,fix_type,gps_id,ignore_flags,time_week_ms,time_week,lat,lon,alt,hdop,vdop,vn,ve,vd,speed_accuracy,horiz_accuracy,vert_accuracy,satellites_visible
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2BHIH2i9fB().pack(_x.fix_type, _x.gps_id, _x.ignore_flags, _x.time_week_ms, _x.time_week, _x.lat, _x.lon, _x.alt, _x.hdop, _x.vdop, _x.vn, _x.ve, _x.vd, _x.speed_accuracy, _x.horiz_accuracy, _x.vert_accuracy, _x.satellites_visible))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.fix_type, _x.gps_id, _x.ignore_flags, _x.time_week_ms, _x.time_week, _x.lat, _x.lon, _x.alt, _x.hdop, _x.vdop, _x.vn, _x.ve, _x.vd, _x.speed_accuracy, _x.horiz_accuracy, _x.vert_accuracy, _x.satellites_visible,) = _get_struct_2BHIH2i9fB().unpack(str[start:end])
      return self
...
def _get_struct_I():
    global _struct_I
    return _struct_I
_struct_2BHIH2i9fB = None
def _get_struct_2BHIH2i9fB():
    global _struct_2BHIH2i9fB
    if _struct_2BHIH2i9fB is None:
        _struct_2BHIH2i9fB = struct.Struct("<2BHIH2i9fB")
    return _struct_2BHIH2i9fB
_struct_3I = None
def _get_struct_3I():
    global _struct_3I
