...
let GetPowerFrissFeedback = require('./GetPowerFrissFeedback.js');
let std_msgs = _finder('std_msgs');
let actionlib_msgs = _finder('actionlib_msgs');

//-----------------------------------------------------------

class GetPowerFrissActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new GetPowerFrissFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = GetPowerFrissFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new GetPowerFrissActionFeedback(null);
    ...
    data.feedback = GetPowerFrissFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetPowerFrissActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = GetPowerFrissFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new GetPowerFrissFeedback()
    }
...
module.exports = GetPowerFrissActionFeedback;
