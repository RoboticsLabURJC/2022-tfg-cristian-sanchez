...
(cl:ensure-generic-function 'new_origin-val :lambda-list '(m))
(cl:defmethod new_origin-val ((m <GetPowerFrissGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader heatmap_util-msg:new_origin-val is deprecated.  Use heatmap_util-msg:new_origin instead.")
  (new_origin m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <GetPowerFrissGoal>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'new_origin) 1 0)) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <GetPowerFrissGoal>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'index)))
    ...
    (cl:setf (cl:slot-value msg 'new_origin) (cl:not (cl:zerop (cl:read-byte istream))))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<GetPowerFrissGoal>)))
  ...
  "bf66fd7cb52c6c3592f291bd8c2212bd")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'GetPowerFrissGoal)))
  "Returns md5sum for a message object of type 'GetPowerFrissGoal"
  "bf66fd7cb52c6c3592f291bd8c2212bd")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GetPowerFrissGoal>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%int16[] index~%bool new_origin~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GetPowerFrissGoal)))
  "Returns full string definition for message of type 'GetPowerFrissGoal"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%int16[] index~%bool new_origin~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <GetPowerFrissGoal>))
  ...
  (cl:list 'GetPowerFrissGoal
    ...
    (cl:cons ':new_origin (new_origin msg))
))
